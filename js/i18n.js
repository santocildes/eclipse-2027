...
const CATALOGO = {
  es: {
    ...
    'dest.barco': 'barco',
    'dest.eligeOrigen': 'Aún no sabemos desde dónde vas a viajar: los tiempos de coche, barco y avión se calculan desde Tarifa por defecto.',
    'dest.usarUbicacion': 'Usar mi ubicación',
  ...
  en: {
    ...
    'dest.barco': 'ferry',
    'dest.eligeOrigen': "We don't know where you're travelling from yet: driving, ferry and flight times default to Tarifa.",
    'dest.usarUbicacion': 'Use my location',
  ...
  fr: {
    ...
    'dest.barco': 'bateau',
    'dest.eligeOrigen': "Nous ne savons pas encore d’où vous partez : les temps de trajet sont calculés depuis Tarifa par défaut.",
    'dest.usarUbicacion': 'Utiliser ma position',
  ...
  ar: {
    ...
    'dest.barco': 'عبّارة',
    'dest.eligeOrigen': 'لا نعرف بعد من أين ستنطلق رحلتك: تُحسب أوقات السيارة والعبّارة والطيران افتراضيًا من تاريفا.',
    'dest.usarUbicacion': 'استخدام موقعي',
    'dest.total': 'كسوف كلي',
