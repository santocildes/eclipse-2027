...
const CATALOGO = {
  es: {
    ...
    'dest.barco': 'barco',
    'dest.sinGafas': 'sin gafas',
    'dest.conGafas': 'gafas siempre',
  ...
  en: {
    ...
    'dest.barco': 'ferry',
    'dest.sinGafas': 'glasses off',
    'dest.conGafas': 'glasses always',
  ...
  fr: {
    ...
    'dest.soloTotales': 'Totales uniquement',
    ...
    'dest.barco': 'bateau',
    'dest.sinGafas': 'sans lunettes',
    'dest.conGafas': 'lunettes toujours',
  ...
  ar: {
    ...
    'dest.barco': 'عبّارة',
    'dest.sinGafas': 'بلا نظارات',
    'dest.conGafas': 'النظارات دائمًا',
